    ...
    +(function() {
        ...
        var i =
            ...
            (function(t) {
                ...
                return (
                    t(document)
                        .on(u.CLICK_DATA_API, c.DATA_TOGGLE_CARROT, function(
                            e
                        ) {
                            e.preventDefault();
                            var n = e.target;
            ...
            (function(t) {
                ...
                return (
                    t(document).on(_.CLICK_DATA_API, m.DATA_TOGGLE, function(
                        e
                    ) {
                        e.preventDefault();
                        ...
                        return (
                            ...
                            (e._clearMenus = function(n) {
                                if (!n || n.which !== f) {
                                    ...
                                    for (
                                        var o = t.makeArray(t(p.DATA_TOGGLE)),
                                            r = 0;
                                        r < o.length;
                                        r++
                                    ) {
            ...
            (function(t) {
                        ...
                        return (
                            ...
                            (h.prototype._setEscapeEvent = function() {
                                ...
                                this._isShown && this._config.keyboard
                                    ...
                                    : this._isShown ||
                                      t(this._element).off(p.KEYDOWN_DISMISS);
                            }),
                            ...
                            (h.prototype._setScrollbar = function() {
                                var e = parseInt(
                                    t(E.FIXED_CONTENT).css('padding-right') ||
                                        0,
                                    10
                                );
                ...
                return (
                    t(document).on(p.CLICK_DATA_API, E.DATA_TOGGLE, function(
                        e
                    ) {
                        var n = this,
                            i = void 0,
            ...
            (function(t) {
                    ...
                    m = (function() {
                        function h(e, i) {
                            ...
                            n(this, h),
                                ...
                                t(this._scrollElement).on(f.SCROLL, function(
                                    t
                                ) {
                                    return o._process(t);
                                }),
                ...
                return (
                    t(window).on(f.LOAD_DATA_API, function() {
                        for (
                            var e = t.makeArray(t(g.DATA_SPY)), n = e.length;
                            n--;
            ...
            (function(t) {
                ...
                return (
                    t(document).on(u.CLICK_DATA_API, f.DATA_TOGGLE, function(
                        e
                    ) {
                        e.preventDefault(),
                        ...
                        return (
                            ...
                            (h.prototype.toggle = function(e) {
                                if (e) {
                                    ...
                                    if (
                                        t(this.getTipElement()).hasClass(m.SHOW)
                                    )
                                            ...
                                            o =
                                                n === T.HOVER
                                                    ...
                                                    : e.constructor.Event
                                                          .FOCUSOUT;
                                        t(e.element)
                                            .on(i, e.config.selector, function(
                                                t
                                            ) {
                                                return e._enter(t);
                                            })
                                            .on(o, e.config.selector, function(
                                                t
                                            ) {
                                                return e._leave(t);
                                            });
